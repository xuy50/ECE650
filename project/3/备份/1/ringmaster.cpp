...
int main(int argc, char *argv[]) {
    ...
    //     send(playersPos[next], &i, sizeof(i), 0);
    //     if (i == 0) {
    //         const char *finishFlag = "f";
    //         int finishHop = -1;
    //         for (size_t j = 0; j < numPlayers; j++) {
    //             if (j != next) {
    //                 send(playersPos[j], &finishHop, sizeof(finishHop), 0);
    //             }
    //             send(playersPos[j], finishFlag, strlen(finishFlag), 0);
    //         }
    //     } else {
    //         const char *finishFlag = "s";
    //         send(playersPos[next], finishFlag, strlen(finishFlag), 0);
    //         recv(playersPos[next], &next, sizeof(next), 0);
    //         cout << i << endl;
    //     }
    //     // cout << "next: " << next << endl;
